...
import ch.lukasakermann.connectfourchallenge.game.strategy.DragonsStrategy;
...
public class ConnectFourClientApplication {
    ...
    public static void main(String[] args) {
        ...
        executor.submit(new GameRunner(connectFourAdapter, "Dragons", new DragonsStrategy(), NUMBER_OF_GAMES));
